...
module.exports = function(app) {
  ...
  app.get('/penalty/add', isLoggedIn, function(req, res) {
  ...
  app.post('/penalty/add', function(req, res) {
    var error, errors, match_id, newUserPenalty, paramError, penalty_id, player_id;
    try {
    ...
    newUserPenalty.save(function(err, result) {
      if (err) {
        return res.json({
